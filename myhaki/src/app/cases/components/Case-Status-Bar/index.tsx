...
export default function CaseStatusBar() {
  ...
  return (
    <div className="min-h h-screen bg-white lg:flex relative">
      ...
      <aside
        className="w-full lg:w-1/4 px-4 py-40 flex flex-row lg:flex-col gap-6 lg:gap-10
                   lg:sticky lg:top-0 [@media(width:1024px)]:ml-[-2%] [@media(width:1024px)]:mt-[-4%]
                   "
      >
        <div
          className="bg-[#B8906E] [@media(width:1024px)]:w-33 [@media(width:1512px)]:mt-[-27%] [@media(width:1366px)]:w-56
                    text-white rounded-lg mb-10 mt-[-20%] px-8 py-4 flex-1 flex flex-col items-center text-center
                    [@media(width:1366px)]:mt-[-30%] [@media(width:1280px)]:mt-[-33%] [@media(width:1024px)]:ml-[-20%]
                    [@media(width:1024px)]:h-auto "
        >
          {loading ? (
        ...
        <div
          className="bg-[#B8906E] [@media(width:1024px)]:w-31 text-white rounded-lg px-6 py-15 [@media(width:1366px)]:h-68 [@media(width:1512px)]:h-70
                     [@media(width:1366px)]:py-10 [@media(width:1366px)]:w-56 [@media(width:1280px)]:h-66 [@media(width:1024px)]: h-48 2xl:h-80
                     [@media(width:1024px)]:mt-[-32%] [@media(width:1024px)]:ml-[-15%] text-center flex flex-col items-center min-w-[100px]"
        >
          <Image
